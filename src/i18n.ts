  ...
  en: {
    translation: {
      ...
      pricing: {
        ...
        annualFeat1: 'Processing on Your PC',
        ...
        monthlyFeat1: 'Processing on Your PC',
  ...
  fr: {
    translation: {
      ...
      pricing: {
        ...
        annualFeat1: 'Traitement sur votre PC',
        ...
        monthlyFeat1: 'Traitement sur votre PC',
  ...
  es: {
    translation: {
      ...
      pricing: {
        ...
        annualFeat1: 'Procesamiento en su PC',
        ...
        monthlyFeat1: 'Procesamiento en su PC',
  ...
  it: {
    translation: {
      ...
      pricing: {
        ...
        annualFeat1: 'Elaborazione sul tuo PC',
        ...
        monthlyFeat1: 'Elaborazione sul tuo PC',
  ...
  de: {
    translation: {
      ...
      pricing: {
        ...
        annualFeat1: 'Verarbeitung auf Ihrem PC',
        ...
        monthlyFeat1: 'Verarbeitung auf Ihrem PC',
  ...
  ru: {
    translation: {
      ...
      pricing: {
        ...
        annualFeat1: 'Обработка на вашем ПК',
        ...
        monthlyFeat1: 'Обработка на вашем ПК',
