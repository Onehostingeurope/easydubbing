    ...
    <div className="bg-[#050505] text-[#e5e2e1] font-['Inter'] min-h-screen">
      ...
      <main className="max-w-3xl mx-auto px-6 py-24">
        ...
        {[
          ...
          { title: '3. Subscription Plans', body: 'Monthly (€19/mo) and Annual (€69/yr) subscriptions are billed automatically via PayPal. You may cancel at any time; cancellation takes effect at the end of the current billing period. The Lifetime license (€99) is a one-time payment with no recurring charges.' },
